...
<fmt:formatNumber value="3200100" type="currency" groupingUsed="true"/></p>
<p> 기본값(천단위구분, 통화기호 설정):
<fmt:formatNumber value="3200100" type="currency" currencySymbol="&#8361;"/></p>
...
<fmt:formatNumber value="3200100.45" pattern=".000"/></p>

<p> 천단위 구분.소수점 두 자리 수까지 표현. 세번째서 반올림:
<fmt:formatNumber value="3200155.456" pattern="#,#00.0#"/></p> 
</body>
</html>